/**
 * Created by kerwinliu on 2017/12/19.
 */
<template>
    <div class="page pg-about">
        ...
        <!-- MAINVIEW -->
        <div class="mainview">
            <section class="about-ledge">
                <div><img src="../../../Assets/Images/about_01.jpg" width="100%"></div>
                ...
                <p>Copyright &copy; 2018 Ledge.cn, Inc. All rights reserved.</p>
            </section>
        </div>
        <!-- //MAINVIEW -->
    </div>
